...
const Welcome = () => {
  ...
  <g id="Group_4" data-name="Group 4" transform="translate(-134 -226)">
    <g id="Group_3" data-name="Group 3" transform="translate(37.5)">
      <text id="CRYPTO" transform="translate(97.5 398)" fill="#fff" stroke="#fff" stroke-width="1" font-size="159" className="fonty"><tspan x="0" y="0">CRYPTO</tspan></text>
      <text id="ANALYSIS_MADE_EASY." data-name="ANALYSIS MADE EASY." transform="translate(114.5 485)" fill="#fff" stroke="#fff" stroke-width="1" font-size="49" className="fonty"><tspan x="0" y="0" >TRANSACTIONS MADE EASY </tspan></text>
      <line id="Line_2" data-name="Line 2" y1="0.5" x2="537" transform="translate(179.5 423)" fill="none" stroke="#fff" stroke-width="2"/>
          ...
          <div className=" fonty grid sm:grid-cols-3 grid-cols-2 w-full mt-20">
